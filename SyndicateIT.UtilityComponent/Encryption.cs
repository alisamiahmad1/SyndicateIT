...
namespace SyndicateIT.UtilityComponent
{
    ...
    public static class Encryption
    {
        ...
        /// </summary>
        static string passwordKey = "/2&^&@!MK@a)&*";

        /// <summary>
        /// Encrypt a string into a string using a password 
        /// </summary>
        /// <param name="clearText">Text to encrypt</param>
        /// <returns>Returns an encrypted string of the text</returns>
        ...
        public static string Decrypt(string cipherText)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception(ex.Message + "-----------------" + cipherText);
            }
        }
        ...
        /// <returns>Returns the byte array of decrypted data</returns>
