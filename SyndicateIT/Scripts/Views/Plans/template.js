...
function onDeleteBillingType(obj) {
    var answer = BootstrapDialog.confirm({
        title: 'Pin Pay',
        message: "Are you sure you want to delete this Billing Type?",
        callback: function (result) {
            if (result) {
               $(".accountType-content", $(obj).parents(".billingType-content")).each(function () {
